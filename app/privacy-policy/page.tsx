  ...
  return (
    <div>
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <h1 className="text-2xl font-bold mb-4 ">YodaCode Privacy Policy</h1>
        <p className="mb-4">
          YodaCode is a free online service that provides a simple way to
