  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 className="text-2xl font-bold mb-4">
        YodaCode Terms and Conditions
      </h1>
      <p className="mb-4">
        These terms and conditions (&quot;Terms&quot;) apply to your use of the
        YodaCode app (&quot;App&quot;) and the alt tag generation service
        (&quot;Service&quot;) provided by YodaCode (&quot;we&quot; or
      ...
      <p className="mb-4">
        In no event shall YodaCode be liable for any direct, indirect,
      ...
      <p className="mb-4">
        You agree to indemnify and hold YodaCode, its affiliates, officers,
      ...
      <p className="mb-4">
        ...
        please contact us at pastsmartlink@gmail.com.
      </p>
      <p className="text-sm">Last Updated: December 16th, 2024</p>
    </div>
  );
};
